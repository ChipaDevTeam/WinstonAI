# filepath: c:\Users\tp\ComunityPrograms\WinstonAI\train.py
...
def find_latest_checkpoint():
    ...
    checkpoint_files = r"WinstonAI\winston_ai_final.pth"

    
    # Find the latest episode
    latest_episode = 0
    print(f"Found latest checkpoint: {checkpoint_files} (Episode {latest_episode})")
    
    return checkpoint_files, latest_episode
...
def train_winston_ai():
    ...
    data_path = r"c:\Users\tp\ComunityPrograms\all_assets_candles2.csv"
    ...
    for episode in range(start_episode, total_episodes):
        ...
        if episode % save_freq == 0 and episode > start_episode:
            model_path = f"winston_ai_episode_{episode}-v1.1.pth"
            metrics = {
