...
class WinstonAITrader:
    ...
    def setup_logging(self):
        ...
        # Set encoding for console to handle emojis better
    ...
    async def execute_trade(self, api, asset, action, confidence):
        ...
        try:
            ...
            if action == 1:  # Call option
                ...
                self.logger.info(f"⏸️ Model suggests HOLD for {asset}")
                return None
    ...
    async def monitor_asset(self, api, asset):
        ...
        try:
            ...
            async for candle_data in api.subscribe_symbol(asset):
                try:
    ...
    async def run_trading_bot(self):
        ...
        try:
            # Initialize API
            ssid = (r'42["auth",{"session":"t04ppgptp3404h0lajp4bo7smh","isDemo":1,"uid":101884312,"platform":2,"isFastHistory":false}]')
...
async def main():
    ...
    trader = WinstonAITrader(
        model_path=r"WinstonAI\winston_ai_episode_400.pth",  # Use the latest episode model
